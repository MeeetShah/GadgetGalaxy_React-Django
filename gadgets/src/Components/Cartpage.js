...
import { specificproduct as updateSpecificProduct } from '../features/products'
                                    ...
                                    return productDetails ? (
                                        <div className="row" key={productDetails.id}>
                                            ...
                                            <div className="col-lg-5 col-md-6 mb-4 mb-lg-0">
                                                ...
                                                <p>Description : {productDetails.description || 'N/A'}</p>
                                                <p>Stock: {productDetails.stock || 'M'}</p>
                                                <p>Brand: {productDetails.brand || 'M'}</p>
